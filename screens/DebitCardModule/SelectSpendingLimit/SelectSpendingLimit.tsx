...
import { SelectSpendingLimitProps, SpendingLimitOption, SpendingLimitScreenNavigationProp } from "../TypeConstants";
    ...
    <SafeAreaView style={selectSpendingLimitScreenStyles.bottomSafeAreaView}>
      ...
      <View style={{flex:1}}>
        ...
        <View style={selectSpendingLimitScreenStyles.titleContainer}>
            <Text style={selectSpendingLimitScreenStyles.title}>Spending limit</Text>
        </View>
      ...
      <View style={selectSpendingLimitScreenStyles.content}>
        ...
        <View style={selectSpendingLimitScreenStyles.contentHeader}>
          ...
          <Text style={selectSpendingLimitScreenStyles.contentTitle}>Set a weekly debit card spending limit</Text>
        </View>

        {/* Currency Badge */}
        <View style={selectSpendingLimitScreenStyles.currencyContainer}>
          <View style={selectSpendingLimitScreenStyles.currencyBadge}>
            <Text style={selectSpendingLimitScreenStyles.currencyText}>S$</Text>
          </View>
          <Text style={selectSpendingLimitScreenStyles.selectedLimitText}>{selectedLimit.toLocaleString()}</Text>
        </View>
          ...
          {spendingLimitOptions.map((option) => (
            <TouchableOpacity
              ...
              style={[
                ...
                isLimitSelected(option.amount) && selectSpendingLimitScreenStyles.optionButtonSelected,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  isLimitSelected(option.amount) && selectSpendingLimitScreenStyles.optionTextSelected,
                ]}
              >
                {option.displayText}
              </Text>
        ...
        <View style={selectSpendingLimitScreenStyles.saveButtonContainer}>
          <TouchableOpacity
            style={[
              ...
              isSaveEnabled() && selectSpendingLimitScreenStyles.saveButtonEnabled,
            ]}
            onPress={handleSave}
          ...
          >
            <Text
              style={[
                ...
                isSaveEnabled() && selectSpendingLimitScreenStyles.saveButtonTextEnabled,
              ]}
            >
              Save
            </Text>
